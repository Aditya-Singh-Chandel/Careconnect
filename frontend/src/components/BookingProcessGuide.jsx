...
import CareconnectLogoWhite from "../assets/CareconnectLogoWhite.png";

function BookingProcessGuide() {
  return (
    <div className="animate-fade-up">
      <div className="my-2 flex w-full justify-center">
        <img src={CareconnectLogoWhite} alt="" className="h-12 md:h-16 w-auto" />
      </div>
      <div className="mb-4 flex select-none justify-center text-center font-noto text-base font-semibold md:text-lg">
        Welcome to Careconnect Appointment Booking
      </div>

      <div className="flex flex-col gap-y-4 font-noto">
        <p>
          At Careconnect, we make booking appointments simple, quick, and
          hassle-free!
        </p>
