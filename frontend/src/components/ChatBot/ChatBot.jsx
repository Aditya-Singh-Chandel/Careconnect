...
import CareconnectLogo from "../../assets/CareconnectLogo";
...
function ChatBot() {
  ...
  const [chatbotMessages2, setChatbotMessages2] = useState([
    {
      message: "Hello, I am Careconnect AI ChatBot. How can I help you today?",
      type: "bot",
    },
    {
    ...
    {
      message: "Yes, I would like to know more about Careconnect.",
      type: "user",
    },
    {
      message:
        "Careconnect is an online platform that allows you to book appointments with doctors and healthcare professionals. You can also consult with doctors online.",
      type: "bot",
    },
    {
  ...
  const [chatbotMessages, setChatbotMessages] = useState([
    {
      type: "bot",
      message: "Hello, I'm Careconnect AI ChatBot. How can I help you today?",
    },
  ]);
            ...
            <div className="pointer-events-auto flex h-full w-full flex-col">
              <div className="chatbot_navbar flex h-10 w-full justify-between">
                <div className="mx-1 flex w-14 items-center">
                  <CareconnectLogo fillColor="#4f4fcc" />
                </div>
              ...
              <div className="flex h-12 w-full items-center gap-x-2 border-red-600 p-2">
                <TextField.Root
                  className="w-full"
                  placeholder="Talk with Careconnect AI ChatBot..."
                  value={message || ""}
