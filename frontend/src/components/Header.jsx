...
import { useCareconnectContext } from "../utils/ContextProvider";
import {
  Avatar,
  Box,
  Button,
...
function Header() {
  const CareconnectContext = useCareconnectContext();
  const { theme, setTheme, profile, setProfile } = CareconnectContext;
  ...
  return (
    ...
    >
      <div
        ...
        onClick={() => navigate("/")}
      >
        <CareconnectLogo fillColor={"#000000"} />
      </div>
