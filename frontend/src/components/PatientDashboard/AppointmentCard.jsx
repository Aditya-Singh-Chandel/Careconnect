...
//     if (scanData != "fail") {
//       const audio = new Audio("/Careconnect/sound/Check_In_Successful.mp3"); // Ensure this file exists in your public folder
...
function AppointmentCard({ data, refetch }) {
  ...
  const handleScanSuccess = (scanData) => {
    ...
    if (scanData !== "fail") {
      const audio = new Audio("/Careconnect/sound/Check_In_Successful.mp3");
      audio.play().catch((err) => console.error("Audio play error:", err));
    }
