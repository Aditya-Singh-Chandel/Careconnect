...
import { useCareconnectContext, useAuthContext } from "../utils/ContextProvider";
...
function Home() {
  const { theme, profile } = useCareconnectContext();
        ...
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <p className="h-7 w-96 text-center font-medium tracking-wider">
            <Typewriter
              ...
              typeSpeed={50}
              delaySpeed={2000}
              words={["Welcome to Careconnect.", "Appointment Booking made easy!"]}
              cursor={true}
            />
          </p>
